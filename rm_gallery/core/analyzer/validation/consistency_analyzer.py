...
class ConsistencyAnalyzer(BaseValidationAnalyzer):
    ...
    def analyze(
        self,
        first_run_results: List[GraderResult],
        second_run_results: List[GraderResult],
        **kwargs,
        ...
        Args:
            first_run_results: Results from the first evaluation run.
            second_run_results: Results from the second evaluation run.
