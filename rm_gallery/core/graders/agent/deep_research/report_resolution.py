...
2. 这是深度研究Agent生成的研究报告:<report_answer>{response}</report_answer>
...
2. This is the research report generated by the deep research Agent: <report_answer>{response}</report_answer>
...
class ReportResolutionGrader(LLMGrader):
    ...
    Example:
        ...
        ...     response="Based on recent research and industry reports...",
        ...     history="",
    ...
    def __init__(
        ...
        """
        Initialize the ReportResolutionGrader.

        Args:
            model: The language model used for evaluation. Can be either a BaseChatModel
                   instance or a dictionary configuration.
            template: The template for generating prompts. Defines how inputs are formatted
                     for the LLM. Can be a PromptTemplate object.
            language: The language of the grader. Defaults to LanguageEnum.ZH.
            resolution_threshold: Threshold for determining if the report is resolved.
                                Score >= threshold means resolved. Defaults to 0.9.
        """
        super().__init__(
    ...
    async def aevaluate(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            response: Deep research agent's report
