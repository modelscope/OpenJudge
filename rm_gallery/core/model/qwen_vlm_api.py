...
from rm_gallery.gallery.grader.multimodal._internal.helpers import MLLMImage


class QwenVLMConfig(BaseModel):
    """
    Configuration for Qwen VLM API
...
class QwenVLAPI(ChatModelBase):
    ...
    async def achat(
        ...
        **kwargs: Any,
        ...
        This implements the ChatModelBase interface.
        """
        # Extract parameters
