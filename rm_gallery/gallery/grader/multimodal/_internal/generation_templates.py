# -*- coding: utf-8 -*-
"""
Generation-based Multimodal Evaluation Templates

Templates for evaluating AI-generated and edited images.
"""
...
class TextToImageTemplate:
    """
    Templates for evaluating text-to-image generation quality

    Evaluates both semantic consistency and perceptual quality.
    """

    @staticmethod
    def generate_semantic_consistency_prompt() -> Template:
        """
        Generate template for evaluating semantic consistency between prompt and image
...
10 indicates the AI generated image follows the prompt perfectly.)
    ...
    @staticmethod
    def generate_perceptual_quality_prompt() -> Template:
        """
        Generate template for evaluating perceptual quality of generated image
...
class ImageEditingTemplate:
    """
    Templates for evaluating image editing quality

    Evaluates both semantic consistency and perceptual quality of edits.
    """

    @staticmethod
    def generate_semantic_consistency_prompt() -> Template:
        """
        Generate template for evaluating semantic consistency of image edits
...
based on the success of the editing. (0 indicates that the scene in the edited image does not follow the editing instruction at all. 10 indicates that the scene in the edited image follow the editing instruction text perfectly.)
    ...
    def generate_perceptual_quality_prompt() -> Template:
        """
        Generate template for evaluating perceptual quality of edited image
