# -*- coding: utf-8 -*-
"""
Prompt templates for multimodal evaluation
"""
...
class MultimodalGEvalTemplate:
    ...
    - Generating evaluation steps from criteria
    - Evaluating test cases based on steps and rubrics
    - Strict binary evaluation (pass/fail)
    """

    @staticmethod
    def generate_evaluation_steps(parameters: str, criteria: str) -> str:
        """
        Generate prompt for creating evaluation steps

        Args:
            parameters: Parameters being evaluated (e.g., "input and actual output")
    ...
    def generate_evaluation_results(
        ...
        """
        Generate prompt for evaluating based on steps and rubric

        Args:
            evaluation_steps: Numbered evaluation steps
            test_case_list: List of test case components (text and images)
            parameters: Parameters being evaluated
            rubric: Optional rubric description
            score_range: Score range (min, max)
            _additional_context: Additional context for evaluation

        Returns:
            List: Prompt parts (text and images)
        """
    ...
    def generate_strict_evaluation_results(
        ...
        """
        Generate prompt for strict binary evaluation

        Args:
            evaluation_steps: Numbered evaluation steps
            test_case_list: List of test case components
            parameters: Parameters being evaluated
        ...
        return (
            ...
            + [
                ...
                **
                ...
                {{
                    "score": 0,
                    "reasoning": "The response does not follow the evaluation steps provided."
                }}
                **
