...
class TestBLEUEdgeCases:
    ...
    async def test_empty_candidate(self):
        ...
        grader = BLEUGrader()
        result = await grader.aevaluate(reference="the cat is on the mat", candidate="")
    ...
    async def test_very_long_sentences(self):
        ...
        result = await grader.aevaluate(reference=long_sentence, candidate=long_sentence)
...
class TestSentenceBLEU:
    ...
    async def test_sentence_bleu_vs_corpus_bleu(self):
        ...
        sentence_result = await sentence_grader.aevaluate(
            reference="the cat is on the mat", candidate="the dog is on the mat"
        )
        corpus_result = await corpus_grader.aevaluate(
            reference="the cat is on the mat", candidate="the dog is on the mat"
        )
