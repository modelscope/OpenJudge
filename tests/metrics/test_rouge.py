...
class TestROUGE1:
    ...
    async def test_rouge1_perfect_match(self):
        ...
        grader = ROUGE1Grader()
        result = await grader.aevaluate(reference="the cat sat", candidate="the cat sat")
    ...
    async def test_rouge1_word_order_independent(self):
        ...
        grader = ROUGE1Grader()
        result = await grader.aevaluate(reference="the cat sat", candidate="sat cat the")
...
class TestROUGE2:
    ...
    async def test_rouge2_no_bigram_overlap(self):
        ...
        grader = ROUGE2Grader()
        result = await grader.aevaluate(reference="a b c d", candidate="b a d c")
...
class TestROUGEEdgeCases:
    ...
    async def test_empty_candidate(self):
        ...
        grader = ROUGEGrader()
        result = await grader.aevaluate(reference="the cat", candidate="")
    ...
    async def test_empty_reference(self):
        ...
        grader = ROUGEGrader()
        result = await grader.aevaluate(reference="", candidate="the cat")
    ...
    async def test_single_word(self):
        ...
        grader = ROUGE1Grader()
        result = await grader.aevaluate(reference="cat", candidate="cat")
    ...
    async def test_repeated_words(self):
        ...
        grader = ROUGE1Grader()
        result = await grader.aevaluate(reference="cat cat cat", candidate="cat dog cat")
